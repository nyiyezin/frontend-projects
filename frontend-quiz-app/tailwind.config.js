...
export default {
  ...
  theme: {
    ...
    fontFamily: { display: ["Rubik", "sans-serif"] },
    extend: {
      colors: {
        "dark-navy": "#313E51",
        "grey-navy": "#626C7F",
      ...
      fontSize: {
        "9xl": ["9rem", { lineHeight: "100%" }],
        "5xl": ["5.5rem", { lineHeight: "100%" }],
        "4xl": ["4rem", { lineHeight: "100%" }],
        "3xl": ["2.5rem", { lineHeight: "100%" }],
        "2xl": ["2.25rem", { lineHeight: "120%" }],
        xl: ["1.75rem", { lineHeight: "100%" }],
        lg: ["1.5rem", { lineHeight: "150%" }],
