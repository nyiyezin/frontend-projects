...
import { incrementScore, setCurrentQuestionIndex, setFinishQuiz } from "@/redux/quizSlice";
import { selectTitle, selectCurrentQuestionIndex } from "@/redux/quizSelector";
...
export function QuizQuestion() {
  ...
  const correctAnswerIndex = shuffledOptions.findIndex((option) => option === currentQuestion?.answer);
  const progress = (((questionIndex as number) + 1) / (selectedQuiz?.questions.length || 1)) * 100;
